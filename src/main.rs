...
COMMANDS
       ...
       decrypt
              Decrypt a file that was encrypted using Age v1/scrypt recipient stanza.
       encrypt
              Encrypt a plaintext file using Age v1/scrypt recipient stanza
